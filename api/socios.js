...
export default async function handler(req,res) {
  ...
  try {
    ...
    return json(res,200,{cnpjs,total:payload?.paginacao?.total??null,tem_proxima_pagina:Boolean(payload?.paginacao?.tem_proxima_pagina),fonte:'CNPJws comercial',aviso:'Resultados sujeitos à atualização e à conferência do QSA. Não equivalem a certidão nacional de vínculos.'});
